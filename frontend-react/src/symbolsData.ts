// Mathematical Symbols Explorer data — history, overlapping meanings, and
// topic connections for 65 symbols. Ported verbatim from the classic
// frontend/symbols.js. `history` and `overlap` may contain <em>/<strong>.
...
export const SYMBOLS: MathSymbol[] = [
  {
    ...
    "meanings": [
      {
        "field": "Arithmetic",
        "desc": "Addition of numbers: 3 + 5 = 8"
      },
      {
        "field": "Set Theory",
        "desc": "Disjoint union of sets: A + B"
      },
      {
        "field": "Linear Algebra",
        "desc": "Direct sum of subspaces: V = U + W"
      },
      {
        "field": "Logic",
        "desc": "Sometimes used for logical OR in circuit notation"
      },
      {
        "field": "String/Concatenation",
        "desc": "In programming and combinatorics, concatenation of sequences"
      }
    ],
    "topics": [
      "Arithmetic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Arithmetic",
        "desc": "Subtraction: 8 − 3 = 5"
      },
      {
        "field": "Set Theory",
        "desc": "Set difference: A − B = A \\ B"
      },
      {
        "field": "Negative numbers",
        "desc": "Unary negation: −5"
      },
      {
        "field": "Charge",
        "desc": "In physics, negative charge"
      }
    ],
    "topics": [
      "Arithmetic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Arithmetic",
        "desc": "Multiplication: 3 × 4 = 12"
      },
      {
        "field": "Set Theory",
        "desc": "Cartesian product: A × B"
      },
      {
        "field": "Vector Calculus",
        "desc": "Cross product: <strong>a</strong> × <strong>b</strong>"
      },
      {
        "field": "Dimensions",
        "desc": "Size notation: 3 × 5 matrix, 1920 × 1080 pixels"
      }
    ],
    "topics": [
      "Arithmetic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Arithmetic",
        "desc": "Division: 12 ÷ 4 = 3"
      },
      {
        "field": "Scandinavian usage",
        "desc": "Subtraction (historically in some Nordic countries!)"
      }
    ],
    "topics": [
      "Arithmetic"
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Arithmetic",
        "desc": "Equality of values: 2 + 3 = 5"
      },
      {
        "field": "Algebra",
        "desc": "Equation to be solved: x² = 4"
      },
      {
        "field": "Definition",
        "desc": "Sometimes used for definitions (though := or ≡ is clearer)"
      },
      {
        "field": "Programming",
        "desc": "Assignment (single =) vs. equality test (==) — a major source of bugs"
      }
    ],
    "topics": [
      "Arithmetic",
    ...
    "meanings": [
      {
        ...
        "desc": "Approximate equality: π ≈ 3.14159"
      },
      {
        "field": "Asymptotic Analysis",
        "desc": "Sometimes used loosely for asymptotic equivalence"
      }
    ],
    "topics": [
      "Numerical Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "Ratio of circumference to diameter: C = πd ≈ 3.14159..."
      },
      {
        "field": "Number Theory",
        "desc": "The prime-counting function: π(x) = number of primes ≤ x"
      },
      {
        "field": "Algebra",
        "desc": "Projection maps in category theory, homotopy groups π_n"
      },
      {
        "field": "Statistics",
        "desc": "Sometimes a probability distribution parameter"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "Summation: Σᵢ₌₁ⁿ aᵢ = a₁ + a₂ + ⋯ + aₙ"
      },
      {
        "field": "Linear Algebra",
        "desc": "Covariance matrix in statistics"
      },
      {
        "field": "Formal Languages",
        "desc": "An alphabet (set of symbols) in automata theory"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Statistics",
        "desc": "Standard deviation: σ, or variance: σ²"
      },
      {
        "field": "Number Theory",
        "desc": "Divisor function: σ(n) = sum of divisors of n"
      },
      {
        "field": "Group Theory",
        "desc": "A permutation: σ ∈ Sₙ"
      },
      {
        "field": "Mechanics",
        "desc": "Stress tensor in engineering"
      },
      {
        "field": "Topology",
        "desc": "A simplex in simplicial complexes"
      }
    ],
    "topics": [
      "Statistics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "Arbitrarily small quantity in ε-δ proofs: for all ε > 0..."
      },
      {
        "field": "Computer Science",
        "desc": "Empty string in formal languages: ε"
      },
      {
        "field": "Physics",
        "desc": "Permittivity of free space: ε₀"
      },
      {
        "field": "Tensor Calculus",
        "desc": "Levi-Civita symbol: εᵢⱼₖ"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "Small change / tolerance in ε-δ proofs"
      },
      {
        "field": "Kronecker delta",
        "desc": "δᵢⱼ = 1 if i=j, 0 otherwise"
      },
      {
        "field": "Dirac delta",
        "desc": "δ(x): generalized function satisfying ∫δ(x)dx = 1"
      },
      {
        "field": "Finite differences",
        "desc": "Small increment: δx"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Calculus",
        "desc": "Finite change: Δx = x₂ − x₁"
      },
      {
        "field": "Algebra",
        "desc": "Discriminant of a quadratic: Δ = b² − 4ac"
      },
      {
        "field": "PDE",
        "desc": "Laplacian operator: Δf = ∇²f"
      },
      {
        "field": "Geometry",
        "desc": "A triangle: △ABC"
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "An angle (along with β, γ)"
      },
      {
        "field": "Statistics",
        "desc": "Significance level (Type I error rate): α = 0.05"
      },
      {
        "field": "Physics",
        "desc": "Fine-structure constant: α ≈ 1/137"
      },
      {
        "field": "Algebra",
        "desc": "A root of a polynomial or a generic element"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "Second angle in a triangle"
      },
      {
        "field": "Statistics",
        "desc": "Type II error probability; regression coefficients"
      },
      {
        "field": "Physics",
        "desc": "Beta decay; v/c ratio in relativity"
      },
      {
        "field": "Special Functions",
        "desc": "Beta function: B(x,y) = ∫₀¹ tˣ⁻¹(1−t)ʸ⁻¹dt"
      }
    ],
    "topics": [
      "Statistics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "Euler-Mascheroni constant: γ ≈ 0.5772"
      },
      {
        "field": "Relativity",
        "desc": "Lorentz factor: γ = 1/√(1 − v²/c²)"
      },
      {
        "field": "Geometry",
        "desc": "Third angle in a triangle"
      },
      {
        "field": "Curves",
        "desc": "A parametric curve: γ(t)"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Linear Algebra",
        "desc": "Eigenvalue: Av = λv"
      },
      {
        "field": "Computer Science",
        "desc": "Lambda calculus, anonymous functions: λx.x+1"
      },
      {
        "field": "Physics",
        "desc": "Wavelength of light or other waves"
      },
      {
        "field": "Probability",
        "desc": "Rate parameter of Poisson/exponential distribution"
      }
    ],
    "topics": [
      "Linear Algebra",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry/Trig",
        "desc": "An angle: sin θ, cos θ"
      },
      {
        "field": "Statistics",
        "desc": "Parameter to be estimated: θ̂ (theta-hat)"
      },
      {
        "field": "CS",
        "desc": "Big-Theta: tight asymptotic bound Θ(n log n)"
      }
    ],
    "topics": [
      "Trigonometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Number Theory",
        "desc": "Euler's totient: φ(n) = count of integers ≤ n coprime to n"
      },
      {
        "field": "Golden Ratio",
        "desc": "φ = (1 + √5)/2 ≈ 1.618 (sometimes τ instead)"
      },
      {
        "field": "Electromagnetism",
        "desc": "Magnetic flux; electric potential"
      },
      {
        "field": "Geometry",
        "desc": "Azimuthal angle in spherical coordinates"
      }
    ],
    "topics": [
      "Number Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "First infinite ordinal: ω = {0, 1, 2, ...}"
      },
      {
        "field": "Physics",
        "desc": "Angular frequency: ω = 2πf"
      },
      {
        "field": "Algebra",
        "desc": "Primitive root of unity: ωⁿ = 1"
      },
      {
        "field": "Differential Forms",
        "desc": "A differential form: ω = f dx + g dy"
      }
    ],
    "topics": [
      "Set Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Statistics",
        "desc": "Population mean: μ"
      },
      {
        "field": "Physics",
        "desc": "Coefficient of friction; magnetic permeability μ₀"
      },
      {
        "field": "Measure Theory",
        "desc": "A measure: μ(A) gives the \"size\" of set A"
      },
      {
        "field": "SI Prefix",
        "desc": "Micro-: μ = 10⁻⁶ (micrometer, microsecond)"
      }
    ],
    "topics": [
      "Statistics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Tau movement",
        "desc": "τ = 2π ≈ 6.2832 (the \"true circle constant\")"
      },
      {
        "field": "Physics",
        "desc": "Torque; proper time in relativity; mean lifetime"
      },
      {
        "field": "Number Theory",
        "desc": "Ramanujan tau function: τ(n)"
      },
      {
        "field": "Topology",
        "desc": "A topology on a set"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "Membership: x ∈ A means x is an element of A"
      },
      {
        "field": "Logic",
        "desc": "\"belongs to\" in predicate logic"
      }
    ],
    "topics": [
      "Set Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "The set with no elements: |∅| = 0"
      },
      {
        "field": "Topology",
        "desc": "∅ is always an open set (and a closed set)"
      }
    ],
    "topics": [
      "Set Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "Union: A ∪ B = elements in A or B (or both)"
      },
      {
        "field": "Measure Theory",
        "desc": "σ-algebras are closed under countable unions"
      }
    ],
    "topics": [
      "Set Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "Intersection: A ∩ B = elements in both A and B"
      },
      {
        "field": "Topology",
        "desc": "Topologies are closed under finite intersections"
      }
    ],
    "topics": [
      "Set Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "Subset: A ⊂ B (every element of A is in B)"
      },
      {
        "field": "Ambiguity!",
        "desc": "Some authors: ⊂ means proper subset; others: ⊂ means ⊆"
      }
    ],
    "topics": [
      "Set Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "The set of real numbers: ℝ = (−∞, ∞)"
      },
      {
        "field": "Linear Algebra",
        "desc": "ℝⁿ = n-dimensional real coordinate space"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "ℕ",
        "desc": "Natural numbers: {0,1,2,...} or {1,2,3,...} depending on convention"
      },
      {
        "field": "ℤ",
        "desc": "Integers: {...,−2,−1,0,1,2,...}"
      },
      {
        "field": "ℚ",
        "desc": "Rational numbers: p/q where p,q ∈ ℤ, q ≠ 0"
      },
      {
        "field": "ℂ",
        "desc": "Complex numbers: a + bi where i² = −1"
      }
    ],
    "topics": [
      "Number Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Logic",
        "desc": "Conjunction: P ∧ Q is true iff both are true"
      },
      {
        "field": "Lattice Theory",
        "desc": "Meet (greatest lower bound): a ∧ b"
      },
      {
        "field": "Exterior Algebra",
        "desc": "Wedge product: v ∧ w (a bivector)"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Logic",
        "desc": "Disjunction: P ∨ Q is true iff at least one is true"
      },
      {
        "field": "Lattice Theory",
        "desc": "Join (least upper bound): a ∨ b"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Logic",
        "desc": "Negation: ¬P is true iff P is false"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Logic",
        "desc": "Material conditional: P → Q (if P then Q)"
      },
      {
        "field": "Functions",
        "desc": "Function mapping: f: A → B"
      },
      {
        "field": "Limits",
        "desc": "\"Approaches\": x → ∞"
      },
      {
        ...
        "desc": "Morphism between objects"
      },
      {
        "field": "Chemistry",
        "desc": "Reaction direction"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Logic",
        "desc": "Universal quantifier: ∀x P(x) means \"for every x, P(x) holds\""
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Logic",
        "desc": "Existential quantifier: ∃x P(x) means \"there exists an x such that P(x)\""
      },
      {
        "field": "Variation",
        "desc": "∃! means \"there exists exactly one\" (uniqueness)"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Proof Theory",
        "desc": "Provability: Γ ⊢ φ means φ is provable from Γ"
      },
      {
        "field": "Type Theory",
        "desc": "Typing judgment: Γ ⊢ e : τ"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Model Theory",
        "desc": "Semantic entailment: Γ ⊨ φ means φ is true in every model of Γ"
      },
      {
        "field": "Satisfaction",
        "desc": "M ⊨ φ means model M satisfies formula φ"
      }
    ],
    "topics": [
      "Logic",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Calculus",
        "desc": "Definite integral: ∫ₐᵇ f(x)dx = area under curve"
      },
      {
        "field": "Measure Theory",
        "desc": "Lebesgue integral: ∫ f dμ"
      },
      {
        "field": "Contour Integration",
        "desc": "∮ f(z)dz (closed contour in complex analysis)"
      },
      {
        "field": "Path Integrals",
        "desc": "Feynman path integral in quantum mechanics"
      }
    ],
    "topics": [
      "Calculus",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Calculus",
        "desc": "Partial derivative: ∂f/∂x"
      },
      {
        "field": "Topology",
        "desc": "Boundary operator: ∂D = boundary of domain D"
      },
      {
        "field": "Homological Algebra",
        "desc": "Boundary map in chain complexes"
      }
    ],
    "topics": [
      "Calculus",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Vector Calculus",
        "desc": "Gradient: ∇f = (∂f/∂x, ∂f/∂y, ∂f/∂z)"
      },
      {
        "field": "Vector Calculus",
        "desc": "Divergence: ∇·F; Curl: ∇×F"
      },
      {
        "field": "PDE",
        "desc": "Laplacian: ∇² = ∂²/∂x² + ∂²/∂y² + ..."
      ...
      {
        "field": "Connections",
        "desc": "Covariant derivative in differential geometry: ∇_X Y"
      }
    ],
    "topics": [
      "Vector Calculus",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Calculus (Leibniz)",
        "desc": "dy/dx — suggests a ratio of infinitesimals"
      },
      {
        "field": "Calculus (Lagrange)",
        "desc": "f′(x) — compact, emphasizes the function"
      },
      {
        "field": "Calculus (Newton)",
        "desc": "ẏ — used in physics for time derivatives"
      },
      {
        "field": "Euler",
        "desc": "Df — operator notation, common in analysis"
      }
    ],
    "topics": [
      "Calculus",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "lim_{x→a} f(x) = L, the value f approaches as x approaches a"
      },
      {
        "field": "Category Theory",
        "desc": "Limit of a diagram (projective limit)"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Calculus",
        "desc": "Unbounded growth: lim_{x→∞}, ∫₁^∞"
      },
      {
        "field": "Set Theory",
        "desc": "Infinite cardinalities: ℵ₀ (countable), 2^ℵ₀ (continuum)"
      },
      {
        "field": "Projective Geometry",
        "desc": "Point at infinity"
      },
      {
        "field": "Topology",
        "desc": "One-point compactification: ℝ ∪ {∞}"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Arithmetic",
        "desc": "Square root: √9 = 3"
      },
      {
        "field": "Algebra",
        "desc": "n-th root: ∛, ∜, or ⁿ√x"
      },
      {
        "field": "Radical Theory",
        "desc": "Radical of an ideal in ring theory"
      }
    ],
    "topics": [
      "Algebra",
  ...
  },
  {
    ...
    "meanings": [
      ...
      {
        "field": "Einstein Convention",
        "desc": "In tensor notation, repeated indices imply summation (no ∑ written)"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Algebra",
        "desc": "Product: ∏ᵢ₌₁ⁿ aᵢ = a₁·a₂·⋯·aₙ"
      },
      {
        "field": "Category Theory",
        "desc": "Categorical product (generalizes Cartesian product)"
      },
      {
        "field": "Topology",
        "desc": "Product topology on ∏ Xᵢ"
      }
    ],
    "topics": [
      "Algebra",
  ...
  },
  {
    ...
    "meanings": [
      ...
      {
        "field": "Logic",
        "desc": "Uniqueness quantifier: ∃!x means exactly one x"
      },
      {
        "field": "Programming",
        "desc": "Logical NOT: !true = false"
      },
      {
        "field": "Topology",
        "desc": "Shriek map (lower shriek f_!, upper shriek f^!)"
      }
    ],
    "topics": [
      "Combinatorics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Linear Algebra",
        "desc": "Tensor product: V ⊗ W"
      },
      {
        "field": "Quantum Computing",
        "desc": "Tensor product of quantum states: |ψ⟩ ⊗ |φ⟩"
      },
      {
        "field": "Logic",
        "desc": "Multiplicative conjunction in linear logic"
      }
    ],
    "topics": [
      "Algebra",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Linear Algebra",
        "desc": "Direct sum: V ⊕ W (V and W intersect trivially)"
      },
      {
        "field": "Logic",
        "desc": "Exclusive OR (XOR): 1 ⊕ 1 = 0"
      },
      {
        "field": "Ring Theory",
        "desc": "Addition in a ring presented as direct sum"
      }
    ],
    "topics": [
      "Algebra",
  ...
  {
    "glyph": "≡",
    "name": "Identically Equal / Congruent",
    "cat": "relations",
    "latex": "\\equiv",
    ...
    "meanings": [
      {
        "field": "Number Theory",
        "desc": "Congruence: 17 ≡ 2 (mod 5)"
      },
      {
        "field": "Logic",
        "desc": "Logical equivalence: P ≡ Q (same truth table)"
      },
      {
        "field": "Analysis",
        "desc": "Identically equal: f(x) ≡ 0 (zero for ALL x, not just some)"
      },
      {
        "field": "Definitions",
        "desc": "Sometimes used for definitions: f(x) ≡ x² + 1"
      }
    ],
    "topics": [
      "Number Theory",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Physics",
        "desc": "Proportionality: F ∝ ma, y ∝ 1/x"
      },
      {
        "field": "Statistics",
        "desc": "In Bayesian inference: posterior ∝ likelihood × prior"
      }
    ],
    "topics": [
      "Physics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Order Theory",
        "desc": "Partial and total order: a ≤ b"
      },
      {
        "field": "Analysis",
        "desc": "Inequalities in proofs"
      },
      {
        "field": "Optimization",
        "desc": "Constraints: f(x) ≤ c"
      }
    ],
    "topics": [
      "Algebra",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Physics",
        "desc": "Dominant scaling: m ≪ M means m is negligible compared to M"
      },
      {
        "field": "Number Theory",
        "desc": "Vinogradov notation: f ≪ g means f = O(g)"
      }
    ],
    "topics": [
      "Physics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Approximation",
        "desc": "Approximately equal: π ~ 3.14"
      },
      {
        "field": "Asymptotic",
        "desc": "Asymptotic equivalence: f ~ g means f/g → 1"
      },
      {
        "field": "Statistics",
        "desc": "\"Distributed as\": X ~ N(0,1)"
      },
      {
        "field": "Equivalence",
        "desc": "Equivalence relation: a ~ b"
      },
      {
        "field": "Complement",
        "desc": "Set complement in some notations: ~A or Ã"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "Absolute value: |x|; norm: ||v||"
      },
      {
        "field": "Number Theory",
        "desc": "Divisibility: a | b means a divides b"
      },
      {
        "field": "Probability",
        "desc": "Conditional: P(A|B) = probability of A given B"
      },
      {
        "field": "Set Theory",
        "desc": "Set-builder: {x | x > 0} (alternatively : )"
      },
      {
        "field": "Cardinality",
        "desc": "|S| = number of elements in S"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      ...
      },
      {
        ...
        "desc": "Argument of a complex number: arg(z) = ∠z"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "Parallel lines: ℓ₁ ∥ ℓ₂"
      },
      {
        "field": "Linear Algebra",
        "desc": "Parallel vectors; norm in some notations"
      },
      {
        "field": "Computing",
        "desc": "Parallel execution (||) in programming"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "Perpendicular: ℓ₁ ⊥ ℓ₂"
      },
      {
        "field": "Logic",
        "desc": "Falsum / bottom: ⊥ (always false)"
      },
      {
        "field": "Linear Algebra",
        "desc": "Orthogonal complement: V⊥"
      },
      {
        "field": "Type Theory",
        "desc": "Empty type (no values)"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "Congruent: △ABC ≅ △DEF (same shape and size)"
      },
      {
        "field": "Algebra",
        "desc": "Isomorphic: G ≅ H (groups with identical structure)"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Geometry",
        "desc": "Similar: △ABC ~ △DEF (same shape, possibly different size)"
      },
      {
        "field": "See also",
        "desc": "All other meanings of ~ (tilde) above"
      }
    ],
    "topics": [
      "Geometry",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Set Theory",
        "desc": "Infinite cardinals: ℵ₀ (countable), ℵ₁, ℵ₂, ..."
      }
    ],
    "topics": [
      "Set Theory",
    ...
    "meanings": [
      {
        ...
        "desc": "Bra-ket: ⟨φ|ψ⟩ = inner product of states"
      },
      {
        "field": "Linear Algebra",
        "desc": "Inner product: ⟨u, v⟩"
      },
      {
        "field": "Group Theory",
        "desc": "Generated group: ⟨a, b⟩ = group generated by a and b"
      },
      {
        "field": "Statistics",
        "desc": "Expected value: ⟨X⟩ = E[X]"
      }
    ],
    "topics": [
      "Quantum Mechanics",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Definitions",
        "desc": "f(x) := x² + 1 means \"f(x) is defined to be x² + 1\""
      },
      {
        "field": "Programming",
        "desc": "Assignment operator in Pascal, Go, and others"
      }
    ],
    "topics": [
      "Foundations",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Functions",
        "desc": "Composition: (f ∘ g)(x) = f(g(x))"
      },
      {
        "field": "Category Theory",
        "desc": "Morphism composition: g ∘ f"
      },
      {
        "field": "Matrices",
        "desc": "Hadamard (elementwise) product in some notations"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      {
        "field": "Analysis",
        "desc": "Euler's number: e ≈ 2.71828, defined as lim_{n→∞} (1+1/n)ⁿ"
      },
      {
        "field": "Identity element",
        "desc": "In group theory, e often denotes the identity element"
      },
      {
        "field": "Physics",
        "desc": "Elementary charge: e ≈ 1.602 × 10⁻¹⁹ C"
      }
    ],
    "topics": [
      "Analysis",
  ...
  },
  {
    ...
    "meanings": [
      ...
      {
        "field": "Indexing",
        "desc": "A common index variable: aᵢ"
      },
      {
        "field": "Engineering",
        "desc": "j = √(−1) in electrical engineering (i = current)"
      }
    ],
    "topics": [
      "Algebra",
